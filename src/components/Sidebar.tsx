    ...
    return (
        <>
            ...
            <motion.aside
                ...
                initial={false}
                animate={{ width: isDesktopOpen || isMobileOpen ? 256 : 80 }}
            >
                ...
                >
                    {isDesktopOpen ? <ChevronLeft className="w-3 h-3" /> : <ChevronRight className="w-3 h-3" />}
                </button>

                <div className="flex flex-col h-full p-4 overflow-hidden">
                    {/* Logo / Brand */}
                    <div className={cn("flex items-center gap-3 mb-10 px-2 h-10", !isDesktopOpen && !isMobileOpen && "justify-center")}>
                    ...
                    {/* Footer / User Info */}
                    <div className={cn("mt-auto pt-4 border-t border-border", !isDesktopOpen && !isMobileOpen && "hidden")}>
